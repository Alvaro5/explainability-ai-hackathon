...
content = orig_content.replace('from model import load_all, C, styled_chart, risk_emoji', 'from model import load_all, C, set_theme, styled_chart, risk_emoji')
...
h1, h2, h3, h4, h5, h6, .st-emotion-cache-10trblm { color: {C['text']} !important; }
